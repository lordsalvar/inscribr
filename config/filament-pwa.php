...
return [
    ...
    */
    ...
    'name' => env('PWA_APP_NAME', config('app.name', 'Inscribr')),
    'short_name' => env('PWA_SHORT_NAME', config('app.name', 'Inscribr')),
    'description' => env('PWA_DESCRIPTION', config('app.name', 'Inscribr') . ' PWA'),
    ...
    */
    ...
    'installation' => [
        ...
        'prompt_delay' => env('PWA_INSTALLATION_DELAY', 150), // milliseconds
        'ios_instructions_delay' => env('PWA_IOS_INSTRUCTIONS_DELAY', 150), // milliseconds
